import sys, os
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QListWidgetItem, QListWidget
from PyQt5 import uic
from PyQt5.QtCore import Qt, pyqtSignal, QEvent, pyqtSlot, QPropertyAnimation, QUrl, QRect, QTimer
from PyQt5.QtGui import QIcon, QPixmap, QPainter, QPainterPath, QPalette, QBrush
...
class PlayList(QWidget):
    ...
    def init_ui(self):
        ...
        self.lyric_timer.start(100)  # 每100ms检查一次歌词
    ...
    def select_song(self,item):
        self.first.player.setMedia(QMediaContent(QUrl.fromLocalFile(self.playlist[self.song_list.row(item)])))
        ...
        self.load_lyrics(self.playlist[self.song_list.row(item)],self.first)
 ...
 #水平裁切图像，并保存在列表中
    ...
    def update_lyrics(self):
        ...
        if new_index != self.current_lyric_index:
            ...
            # '''更新浮动歌词条'''
            # self.lrc.lyric_label.setText(self.lyrics[new_index][1])
            # self.lrc.lyric_label.fade_in()